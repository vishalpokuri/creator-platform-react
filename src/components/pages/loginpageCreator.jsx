        ...
        <div className="m-auto ">
          <Card className="m-16">
            <CardHeader className="space-y-1">
              <CardTitle className="text-2xl">Join as Creator</CardTitle>
              <CardDescription>
                Create an account to start sharing your content with the world.
              </CardDescription>
            </CardHeader>
            <CardContent className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Input id="creator-password" type="password" />
              </div>
            </CardContent>
            <CardFooter>
...
export default LoginPageCreator;
